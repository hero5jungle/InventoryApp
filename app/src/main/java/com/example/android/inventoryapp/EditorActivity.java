...
public class EditorActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mCurrentPetUri == null) {
            // This is a new inventory, so change the app bar to say "Add a Pet"
            setTitle(getString(R.string.editor_activity_title_new_inventory));

            invalidateOptionsMenu();
        } else {
            // Otherwise this is an existing inventory, so change app bar to say "Edit Pet"
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!TextUtils.isEmpty(selection)) {
                    if (selection.equals(getString(R.string.gender_male))) {
                        mGender = InventoryEntry.GENDER_MALE;
                    } else if (selection.equals(getString(R.string.gender_female))) {
                        mGender = InventoryEntry.GENDER_FEMALE;
                    } else {
    ...
    private void savePet() {
        ...
        values.put(InventoryEntry.COLUMN_PET_WEIGHT, weight);
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        ...
        String[] projection = {
                ...
                InventoryEntry.COLUMN_PET_GENDER,
                InventoryEntry.COLUMN_PET_WEIGHT };

        // This loader will execute the ContentProvider's query method on a background thread
        return new CursorLoader(this,   // Parent activity context
                mCurrentPetUri,         // Query the content URI for the current inventory
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            int weightColumnIndex = cursor.getColumnIndex(InventoryEntry.COLUMN_PET_WEIGHT);
